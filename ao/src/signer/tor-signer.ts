...
export class TorSigner implements Signer {
  readonly ownerLength: number = PUBLIC_KEY_LENGTH
  readonly signatureLength: number = SIGNATURE_LENGTH
  ...
  async sign(message: Uint8Array): Promise<Uint8Array> {
    ...
    const blindPublicKey = onion_public_key_from_expanded_key(a)
 ...
 */
export function onion_public_key_from_expanded_key(aExt: Uint8Array) {
...
export function expand_onion_private_key(secretKey: Uint8Array) {
